...
//        XmlBeanFactory factory = new XmlBeanFactory(res);
		...
		WishMessageGenerator generator=context.getBean("com.niltech.beans.WishMessageGenerator#0",WishMessageGenerator.class);
		WishMessageGenerator generator1=context.getBean("com.niltech.beans.WishMessageGenerator#1",WishMessageGenerator.class);
		/*
