...
public class StrategyDPTest {
	...
	public static void main(String[] args) {
        ...
        //FileSystemXmlApplicationContext ctx=new FileSystemXmlApplicationContext("src/main/java/com/niltech/common/applicationContext.xml");
		 ...
		 * 
		 * System.out.println(result); ctx.close();
		 */
	}
